...
- (void)setupLabels {
	...
	self.label.textAlignment = MBLabelAlignmentCenter;
	...
	self.detailsLabel.textAlignment = MBLabelAlignmentCenter;
...
- (void)layoutSubviews {
	...
	CGSize labelSize = MB_TEXTSIZE(self.label.text, self.label.font);
	...
	CGSize detailsLabelSize = MB_MULTILINE_TEXTSIZE(self.detailsLabel.text, self.detailsLabel.font, maxSize, self.detailsLabel.lineBreakMode);
	...
	self.detailsLabel.frame = detailsLabelF;
